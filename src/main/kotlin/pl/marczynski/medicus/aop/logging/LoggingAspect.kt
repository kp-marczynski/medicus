package pl.marczynski.medicus.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(pl.marczynski.medicus.repository..*)" +
            " || within(pl.marczynski.medicus.service..*)" +
            " || within(pl.marczynski.medicus.web.rest..*)"
    )
