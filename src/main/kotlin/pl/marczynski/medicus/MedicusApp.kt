...
import pl.marczynski.medicus.config.ApplicationProperties
...
class MedicusApp(private val env: Environment) : InitializingBean {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<MedicusApp>(*args) { addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(MedicusApp::class.java)
