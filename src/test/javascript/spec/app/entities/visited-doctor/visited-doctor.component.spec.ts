...
import { VisitedDoctorComponent } from 'app/entities/visited-doctor/visited-doctor.component';
...
describe('Component Tests', () => {
  describe('VisitedDoctor Management Component', () => {
    let comp: VisitedDoctorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VisitedDoctorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.visitedDoctors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
