...
import { ExaminationComponent } from 'app/entities/examination/examination.component';
...
describe('Component Tests', () => {
  describe('Examination Management Component', () => {
    let comp: ExaminationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ExaminationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.examinations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
