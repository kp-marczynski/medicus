...
import {MedicusExaminationPackageModule} from "app/entities/examination-package/examination-package.module";
...
@NgModule({
  imports: [MedicusSharedModule, RouterModule.forChild(ENTITY_STATES), MedicusVisitedDoctorInjectableModule, MedicusExaminationPackageModule, MedicusExaminationPackageInjectableModule, MedicusTreatmentInjectableModule, MedicusProcedureInjectableModule, MedicusSymptomInjectableModule],
  declarations: [
