...
class ExaminationPackageResource(
    ...
    fun getAllExaminationPackages(
        ...
        val page: Page<ExaminationPackage> = if (eagerload) {
            examinationPackageRepository.findAllWithEagerRelationships(pageable)
        } else {
            examinationPackageRepository.findAll(pageable)
        }
    ...
    fun getExaminationPackage(@PathVariable id: Long): ResponseEntity<ExaminationPackage> {
        ...
        val examinationPackage = examinationPackageRepository.findOneWithEagerRelationships(id)
