...
describe('Service Tests', () => {
  describe('VisitedDoctor Service', () => {
    let injector: TestBed;
    let service: VisitedDoctorService;
    let httpMock: HttpTestingController;
    let elemDefault: IVisitedDoctor;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a VisitedDoctor', () => {
      ...
      it('should delete a VisitedDoctor', () => {
